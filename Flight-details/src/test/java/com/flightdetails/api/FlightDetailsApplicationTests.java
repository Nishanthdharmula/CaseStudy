	...
	public void contextLoads() {
	 ...
	 @Test
	   public void testUpdateFlight() {
	       int id = 1;
	       Flight flight = restTemplate.getForObject(getRootUrl() + "/flight/" + id, Flight.class);
	       flight.setId(1);
	       ...
	       restTemplate.put(getRootUrl() + "/flight/" + id, flight);
	       Flight updatedFlight = restTemplate.getForObject(getRootUrl() + "/flight/" + id, Flight.class);
	  ...
	  public void testGetFlightById() {
		  Flight flight = restTemplate.getForObject(getRootUrl() + "/findflight/1", Flight.class);
